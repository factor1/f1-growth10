...
$section = 'dashboard_partner_grid';
$intro = get_field($section . '_intro');
$plan_id = get_field($section . '_plan_id');
$user_id = get_current_user_id();
$can_see = wc_memberships_is_user_member( $user_id, $plan_id );

if( have_rows($section) && $can_see ) :
  $i = 0; ?>
