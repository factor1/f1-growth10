...
},{"jquery":"../../node_modules/jquery/dist/jquery.js"}],"cta-hashed.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = renderPlan;
...
function renderPlan(plan) {
  ...
  var monthContainer = jQuery('#monthly');
  console.log('Month container: ', monthContainer);
  var annualContainer = jQuery('#annual');
  var errorContainer = jQuery('#error');
  var planContainer = jQuery('#plan-data');

  var costTemplate = function costTemplate(selectedPlan, type) {
    return "<div id=\"".concat(type ? 'month' : 'annual', "-plan-").concat(plan, "\"><h5>$").concat(type ? selectedPlan.variations.month.cost : selectedPlan.variations.annual.cost, "</h5><a href=\"https://growth10.com/cart/?add-to-cart=").concat(selectedPlan.product_id, "&variation_id=").concat(type ? selectedPlan.variations.month.id : selectedPlan.variations.annual.id, "\" class=\"button button--teal active\" role=\"link\">Register here</a></div>");
  };

  var selected = plans.find(function (x) {
    return x.id === plan;
  });
...
var _ctaHashed = _interopRequireDefault(require("./cta-hashed"));
...
_micromodal.default.init(); // Reset modal iframe on close


(0, _jquery.default)(".modal__close").on("click", function () {
  var currentModal = (0, _jquery.default)(this).parents(".modal");
  var iframeSrc = (0, _jquery.default)(this).parents(".modal").find("iframe").attr("src");
...
(0, _jquery.default)(document).on("click", function (e) {
  var currentModal = (0, _jquery.default)(e.target).closest(".modal");
...
(0, _jquery.default)(document).ready(function ($) {
  ...
  if (hash != '') {
    (0, _ctaHashed.default)(parseInt(hash));
  } else {
    $('#plan-data').hide();
    $('#error').show();
